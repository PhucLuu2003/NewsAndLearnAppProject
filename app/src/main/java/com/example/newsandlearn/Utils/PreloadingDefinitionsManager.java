...
/**
 * PreloadingDefinitionsManager - Pre-load định nghĩa từ khó trước khi người dùng đọc đến
...
public class PreloadingDefinitionsManager {
     ...
     */
    public void preloadArticleDefinitions(Context context, String articleContent, String userLevel, PreloadCallback callback) {
        if (isPreloading) {
        ...
        String analysisPrompt = "Analyze this article and identify difficult vocabulary words for a " + userLevel + " English learner:\n\n" +

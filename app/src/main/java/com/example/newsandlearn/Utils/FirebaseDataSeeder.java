...
public class FirebaseDataSeeder {
                                ...
                                seedVideoLessons(new SeedCallback() {
                                        ...
                                        public void onSuccess(String message) {
                                                ...
                                                seedReadingLessons(new SeedCallback() {
                                                        ...
                                                        public void onSuccess(String message) {
                                                                callback.onProgress(
                                                                                "Reading lessons created: " + message);
                                                                ...
                                                                seedListeningLessons(new SeedCallback() {
                                                                        ...
                                                                        public void onSuccess(String message) {
                                                                                ...
                                                                                seedSpeakingLessons(new SeedCallback() {
                                                                                                ...
                                                                                                seedWritingLessons(
                                                                                                                new SeedCallback() {
                                                                                                                                                                ...
                                                                                                                                                                seedUserVocabulary(
                                                                                                                                                                                ...
                                                                                                                                                                                new SeedCallback() {
                                                                                                                                                                                        ...
                                                                                                                                                                                        public void onFailure(
                                                                                                                                                                                                        String error) {
                                                                                                                                                                                                callback.onFailure(
                                                                                                                                                                                                                "Error creating user vocabulary: "
                                                                                                                                                                                                                                + error);
                                                                                                                                                                                        }
                                                                                                                                                                                });
                                                                                                                                                        }
                                                                                                                        ...
                                                                                                                        public void onFailure(
                                                                                                                                        String error) {
                                                                                                                                callback.onFailure(
                                                                                                                                                "Error creating writing lessons: "
                                                                                                                                                                + error);
                                                                                                                        }
                                                                                                                });
                                                                                        }
                                                                                        ...
                                                                                        public void onFailure(
                                                                                                        String error) {
                                                                                                callback.onFailure(
                                                                                                                "Error creating speaking lessons: "
                                                                                                                                + error);
                                                                                        }
                                                                                });
                                                                        }
                                                                        ...
                                                                        public void onFailure(String error) {
                                                                                callback.onFailure(
                                                                                                "Error creating listening lessons: "
                                                                                                                + error);
                                                                        }
                                                                });
                                                        }
                                                        ...
                                                        @Override
                                                        public void onFailure(String error) {
                                                                callback.onFailure("Error creating reading lessons: "
                                                                                + error);
                                                        }
                                                });
                                        }
                ...
                db.collection("vocabularies")
                                ...
                                .addOnSuccessListener(querySnapshot -> {
                                        if (querySnapshot.isEmpty()) {
                                                callback.onFailure(
                                                                "No vocabularies found. Please seed vocabularies first.");
                                                return;
                                        }
                                        ...
                                        for (com.google.firebase.firestore.DocumentSnapshot doc : querySnapshot
                                                ...
                                                batch.set(db.collection("users").document(userId)
                                                                .collection("user_vocabulary").document(vocabId),
                                                                userVocab);
                                                count++;
                                        }
                                        ...
                                        batch.commit()
                                                        .addOnSuccessListener(aVoid -> {
                                                                ...
                                                                callback.onSuccess(finalCount
                                                                                + " words added to user vocabulary");
                                                        })
                                                        .addOnFailureListener(e -> {
        ...
        private List<Vocabulary> createSampleVocabularies() {
                ...
                vocabularies.add(createVocab("work_03", "Manager", "Quản lý", "/ˈmænɪdʒə/", "Business", "B1",
                                Arrays.asList("My manager is very supportive.",
                                                "She's the manager of this department."),
                ...
                vocabularies.add(createVocab("work_05", "Salary", "Lương", "/ˈsæləri/", "Business", "B1",
                                ...
                                Arrays.asList("Mức lương mong đợi của bạn là bao nhiêu?",
                ...
                vocabularies.add(createVocab("work_09", "Presentation", "Thuyết trình", "/ˌpreznˈteɪʃn/", "Business",
                                "B1",
                ...
                vocabularies.add(createVocab("work_12", "Agreement", "Thỏa thuận", "/əˈɡriːmənt/", "Business", "B1",
                                Arrays.asList("We reached an agreement.",
                                                "The agreement is beneficial for both parties."),
                ...
                vocabularies.add(createVocab("work_18", "Goal", "Mục tiêu", "/ɡəʊl/", "Business", "B1",
                                ...
                                Arrays.asList("Mục tiêu nghề nghiệp của bạn là gì?",
                                                "Chúng tôi đạt mục tiêu bán hàng.")));
                vocabularies.add(createVocab("work_19", "Performance", "Hiệu suất", "/pəˈfɔːməns/", "Business", "B1",
                                ...
                                Arrays.asList("Hiệu suất của bạn xuất sắc.",
                                                "Chúng tôi đánh giá hiệu suất hàng quý.")));
                ...
                vocabularies.add(createVocab("tech_03", "Website", "Trang web", "/ˈwebsaɪt/", "Technology", "B1",
                                Arrays.asList("Visit our website for more information.",
                ...
                vocabularies.add(createVocab("tech_12", "Server", "Máy chủ", "/ˈsɜːvə/", "Technology", "B1",
                                ...
                                Arrays.asList("Máy chủ không phản hồi.",
                                                "Chúng tôi lưu trữ trang web trên máy chủ này.")));
                                                ...
                                                seedSpeakingLessons(new SeedCallback() {
                                                        ...
                                                        public void onSuccess(String message) {
                                                                ...
                                                                seedReadingLessons(new SeedCallback() {
                                                                        @Override
                                                                        public void onSuccess(String message) {
                                                                                callback.onProgress("Reading lessons: "
                                                                                                + message);
                                                                                        ...
                                                                                        public void onSuccess(
                                                                                                ...
                                                                                                callback.onProgress(
                                                                                                                "Writing lessons: "
                                                                                                                                + message);
                                                                                                callback.onSuccess(
                                                                                                                "All Learn modules data created successfully!");
                                                                                        }
                                                                        ...
                                                                        public void onFailure(String error) {
                                                                                callback.onFailure(
                                                                                                "Error creating reading lessons: "
                                                                                                                + error);
                                                                        }
                                                                });
                                                        }
                                                        ...
                                                        @Override
                                                        public void onFailure(String error) {
                                                                callback.onFailure("Error creating speaking lessons: "
                                                                                + error);
                                                        }
                                                });
                                        }
        ...
        public void seedGrammarLessons(SeedCallback callback) {
                ...
                lesson1.put("description",
                                "Learn how to use the present simple tense for habits, facts, and general truths.");
                ...
                lesson5.put("description",
                                "Learn how to use modal verbs to express ability, possibility, advice, and obligation.");
        ...
        public void seedListeningLessons(SeedCallback callback) {
                ...
                lesson1.put("audioUrl",
                                "https://av.voanews.com/clips/VLE/2023/11/20/20231120_Let_s_Learn_English_Lesson_1.mp3");
                ...
                lesson1.put("exercises", Arrays.asList(
                                createListeningExercise("How is person B feeling?", "Fine",
                                                Arrays.asList("Fine", "Tired", "Sad", "Angry")),
                                createListeningExercise("What do they say at the end?", "Nice to meet you", Arrays
                                                .asList("Goodbye", "See you later", "Nice to meet you", "Thank you"))));
                lesson1.put("createdAt", new Date());
                ...
                lesson2.put("exercises", Arrays.asList(
                                createListeningExercise("How much is the shirt?", "$25",
                                                Arrays.asList("$15", "$20", "$25", "$30")),
                                createListeningExercise("What color does the customer want?", "Blue",
                                                Arrays.asList("Red", "Blue", "Green", "Black")),
                                createListeningExercise("What size does the customer need?", "Medium",
                                                Arrays.asList("Small", "Medium", "Large", "Extra Large"))));
                lesson2.put("createdAt", new Date());
                ...
                lesson3.put("exercises", Arrays.asList(
                                createListeningExercise("What will the weather be like in the morning?", "Sunny",
                                                Arrays.asList("Rainy", "Sunny", "Cloudy", "Windy")),
                                createListeningExercise("What is the morning temperature?", "25 degrees",
                                                Arrays.asList("20 degrees", "25 degrees", "30 degrees", "15 degrees")),
                                createListeningExercise("What should you bring?", "Umbrella",
                                                Arrays.asList("Sunglasses", "Jacket", "Umbrella", "Hat"))));
                lesson3.put("createdAt", new Date());
        ...
        private Map<String, Object> createListeningExercise(String question, String correctAnswer,
                        List<String> options) {
                Map<String, Object> exercise = new HashMap<>();
                exercise.put("question", question);
        ...
        public void seedSpeakingLessons(SeedCallback callback) {
                ...
                lesson1.put("exercises", Arrays.asList(
                                createSpeakingExercise("Introduce yourself",
                                                "Record yourself introducing your name, where you're from, and what you do."),
                                createSpeakingExercise("Talk about hobbies",
                                                "Speak for 30 seconds about your hobbies and interests.")));
                lesson1.put("createdAt", new Date());
                ...
                lesson2.put("exercises", Arrays.asList(
                                createSpeakingExercise("Describe your morning routine",
                                                "Talk about what you do from waking up until leaving home."),
                                createSpeakingExercise("Talk about your evening",
                                                "Describe your activities after work or school.")));
                lesson2.put("createdAt", new Date());
                ...
                lesson3.put("exercises", Arrays.asList(
                                createSpeakingExercise("Give your opinion on social media",
                                                "Express your views on the advantages and disadvantages of social media."),
                                createSpeakingExercise("Agree or disagree",
                                                "Respond to this statement: 'Learning English is essential in today's world.'")));
                lesson3.put("createdAt", new Date());
                ...
                lesson4.put("exercises", Arrays.asList(
                                createSpeakingExercise("Describe your best friend",
                                                "Talk about your best friend's appearance and personality."),
                                createSpeakingExercise("Describe a family member",
                                                "Describe someone in your family in detail.")));
                lesson4.put("createdAt", new Date());
                ...
                lesson5.put("exercises", Arrays.asList(
                                createSpeakingExercise("Talk about your favorite hobby",
                                                "Explain why you enjoy this hobby and how often you do it."),
                                createSpeakingExercise("Describe a new hobby you want to try",
                                                "Talk about a hobby you'd like to start and why.")));
                lesson5.put("createdAt", new Date());
                ...
                lesson6.put("exercises", Arrays.asList(
                                createSpeakingExercise("Describe your hometown",
                                                "Talk about the location, size, and main features of your hometown."),
                                createSpeakingExercise("Describe a place you visited",
                                                "Describe a city or tourist attraction you've been to.")));
                ...
                lesson7.put("exercises", Arrays.asList(
                                createSpeakingExercise("Tell a memorable story",
                                                "Share a memorable experience from your past."),
                                createSpeakingExercise("Describe a funny incident",
                ...
                lesson8.put("exercises", Arrays.asList(
                                createSpeakingExercise("Describe your favorite gadget",
                                                "Talk about a device you use daily and explain why it's important to you."),
                                createSpeakingExercise("Technology pros and cons",
                                                "Discuss both positive and negative impacts of social media.")));
                ...
                lesson9.put("exercises", Arrays.asList(
                                createSpeakingExercise("Make weekend plans",
                                                "Suggest activities for the weekend and arrange the details."),
                                createSpeakingExercise("Decline an invitation",
                                                "Politely refuse an invitation and suggest an alternative.")));
                ...
                lesson10.put("description",
                                "Prepare for job interviews with common questions and professional responses.");
                ...
                lesson10.put("exercises", Arrays.asList(
                                createSpeakingExercise("Introduce yourself professionally",
                                                "Give a 1-minute professional introduction."),
                                createSpeakingExercise("Answer: Why should we hire you?",
                                                "Explain why you're the best candidate for a position.")));
        ...
        public void seedReadingLessons(SeedCallback callback) {
                ...
                lesson1.put("level", "A1");
                // NOTE: category must match ReadingFragment chips ("news" / "story")
                lesson1.put("category", "story");
                lesson1.put("imageUrl", "https://source.unsplash.com/featured/1200x800?beach,family");
                ...
                lesson1.put("estimatedMinutes", 1);
                lesson1.put("keyVocabulary", Arrays.asList("beach", "weather", "umbrella", "picnic", "refreshing"));
                lesson1.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "When did the family go to the beach?",
                                                "Last Sunday",
                                                Arrays.asList("Last Saturday", "Last Sunday", "Yesterday",
                                                                "Last Friday"),
                                                "The passage begins with: \"Last Sunday, my family went to the beach.\""),
                                createReadingExercise(
                                                "What was the weather like?",
                                                "Beautiful and sunny",
                                                Arrays.asList("Rainy", "Cloudy", "Beautiful and sunny", "Windy"),
                                                "The story says the weather was beautiful and the sun was shining."),
                                createReadingExercise(
                                                "What did they eat for lunch?",
                                                "Sandwiches and fruit",
                                                Arrays.asList("Pizza", "Sandwiches and fruit", "Rice", "Noodles"),
                                                "At noon, they had a picnic and ate sandwiches and fruit."),
                                createReadingExercise(
                                                "What time did they leave the beach?",
                                                "5 o'clock",
                                                Arrays.asList("3 o'clock", "4 o'clock", "5 o'clock", "6 o'clock"),
                                                "The passage states: \"We stayed at the beach until 5 o'clock.\"")));
                lesson1.put("createdAt", new Date());
                ...
                lesson2.put("level", "A2");
                lesson2.put("category", "news");
                lesson2.put("imageUrl", "https://source.unsplash.com/featured/1200x800?english,study,books");
                ...
                lesson2.put("estimatedMinutes", 2);
                lesson2.put("keyVocabulary",
                                Arrays.asList("widely", "international", "opportunities", "access", "valuable"));
                lesson2.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "How many people speak English?",
                                                "More than 1.5 billion",
                                                Arrays.asList("500 million", "1 billion", "More than 1.5 billion",
                                                                "2 billion"),
                                                "The passage says: \"More than 1.5 billion people speak English.\""),
                                createReadingExercise(
                                                "Why is English important for business?",
                                                "Many companies require English speakers",
                                                Arrays.asList("It's easy to learn",
                                                                "Many companies require English speakers", "It's fun",
                                                                "It's old"),
                                                "It explains that English is the language of international business and many companies require it."),
                                createReadingExercise(
                                                "What percentage of websites are in English?",
                                                "Most websites",
                                                Arrays.asList("Few websites", "Some websites", "Most websites",
                                                                "No websites"),
                                                "The passage states: \"Most websites and online content are in English.\""),
                                createReadingExercise(
                                                "How does learning English affect your brain?",
                                                "Makes you smarter",
                                                Arrays.asList("Makes you tired", "Makes you smarter",
                                                                "Makes you confused", "No effect"),
                                                "It says learning a new language can make you smarter and improve memory.")));
                lesson2.put("createdAt", new Date());
                ...
                lesson3.put("level", "B1");
                lesson3.put("category", "news");
                lesson3.put("imageUrl", "https://source.unsplash.com/featured/1200x800?technology,education,tablet");
                ...
                lesson3.put("estimatedMinutes", 3);
                lesson3.put("keyVocabulary", Arrays.asList("platforms", "accessible", "gamification", "virtual reality",
                                "challenges"));
                lesson3.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "What has technology done to education?",
                                                "Revolutionized it",
                                                Arrays.asList("Destroyed it", "Revolutionized it", "Ignored it",
                                                                "Complicated it"),
                                                "The first sentence says technology has revolutionized education."),
                                createReadingExercise(
                                                "What is one benefit of online learning?",
                                                "More accessible",
                                                Arrays.asList("More expensive", "More accessible", "More difficult",
                                                                "Less effective"),
                                                "The passage says online platforms make education more accessible."),
                                createReadingExercise(
                                                "What do language learning apps use?",
                                                "Gamification",
                                                Arrays.asList("Books", "Gamification", "Tests", "Lectures"),
                                                "It mentions apps use gamification to make learning fun and engaging."),
                                createReadingExercise(
                                                "What is mentioned as a challenge?",
                                                "Unequal access to technology",
                                                Arrays.asList("Too easy", "Unequal access to technology",
                                                                "Too expensive", "Too boring"),
                                                "It says not all students have equal access to devices and internet connections.")));
                lesson3.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_03"), lesson3);
                count++;

                // Lesson 4: News - Small Habits
                Map<String, Object> lesson4 = new HashMap<>();
                lesson4.put("id", "reading_04");
                lesson4.put("title", "Small Habits, Big Results");
                lesson4.put("description", "A practical article about building habits for long-term progress.");
                lesson4.put("level", "B1");
                lesson4.put("category", "news");
                lesson4.put("imageUrl", "https://source.unsplash.com/featured/1200x800?habits,journal,coffee");
                lesson4.put("passage",
                                "Many people want big changes, but they try to do everything at once. This often fails because motivation is not stable. A better approach is to build small habits. A habit is a behavior you repeat regularly. When a habit is small, it feels easy, so you are more likely to do it again tomorrow.\n\n"
                                                + "For example, if you want to read more, you can start with five minutes a day. If you want to exercise, you can begin with a short walk after dinner. Over time, these small actions become automatic. They also create a sense of progress.\n\n"
                                                + "Another key idea is consistency. Doing a small habit every day is usually more powerful than doing a big habit once a week. Consistency builds trust in yourself. When you trust yourself, you become more confident and you take on harder goals.\n\n"
                                                + "Finally, remember that habits need a supportive environment. If you want to practice English, keep a short article on your phone and open it during a break. If you want to eat healthier, prepare simple snacks in advance. Small habits, repeated daily, can produce big results.");
                lesson4.put("wordCount", 420);
                lesson4.put("estimatedMinutes", 3);
                lesson4.put("keyVocabulary", Arrays.asList("motivation", "approach", "regularly", "automatic",
                                "consistency", "supportive"));
                lesson4.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "Why do people often fail when they try to change everything at once?",
                                                "Because motivation is not stable",
                                                Arrays.asList("Because motivation is not stable",
                                                                "Because habits are always boring",
                                                                "Because small habits are too hard",
                                                                "Because goals should be avoided"),
                                                "The passage explains that big changes fail because motivation is not stable."),
                                createReadingExercise(
                                                "What is the main benefit of small habits?",
                                                "They feel easy and are repeatable",
                                                Arrays.asList("They require expensive tools",
                                                                "They feel easy and are repeatable",
                                                                "They work only for athletes",
                                                                "They replace all goals"),
                                                "Small habits feel easy, so you are more likely to repeat them tomorrow."),
                                createReadingExercise(
                                                "What makes habits easier to keep?",
                                                "A supportive environment",
                                                Arrays.asList("A supportive environment", "Perfect weather",
                                                                "Watching TV", "Avoiding routines"),
                                                "It says habits need a supportive environment (like keeping an article on your phone).")));
                lesson4.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_04"), lesson4);
                count++;

                // Lesson 5: Story - The Lost Phone
                Map<String, Object> lesson5 = new HashMap<>();
                lesson5.put("id", "reading_05");
                lesson5.put("title", "The Lost Phone");
                lesson5.put("description", "A short story about staying calm and solving a problem.");
                lesson5.put("level", "A2");
                lesson5.put("category", "story");
                lesson5.put("imageUrl", "https://source.unsplash.com/featured/1200x800?bus,phone,city");
                lesson5.put("passage",
                                "Lan was on her way home after class. The bus was crowded and noisy. She held her bag close and listened to music. When the bus stopped, she quickly got off and walked toward a small shop.\n\n"
                                                + "Suddenly, she touched her pocket and froze. Her phone was not there. She checked her bag, her jacket, and the ground. Nothing. For a moment, she felt panic. Then she took a deep breath and tried to think clearly.\n\n"
                                                + "Lan remembered that she used her phone on the bus. She walked back to the bus stop and asked a driver. The driver said, \"The next bus is coming in two minutes.\" Lan waited and watched the road carefully.\n\n"
                                                + "When the bus arrived, Lan stepped inside and looked at the seats. There, near the window, was her phone. She thanked the driver and smiled. On the way home, she learned an important lesson: staying calm helps you find solutions faster.");
                lesson5.put("wordCount", 360);
                lesson5.put("estimatedMinutes", 3);
                lesson5.put("keyVocabulary",
                                Arrays.asList("crowded", "froze", "panic", "clearly", "carefully", "lesson"));
                lesson5.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "Where did Lan last use her phone?",
                                                "On the bus",
                                                Arrays.asList("On the bus", "In the shop", "At home", "At school"),
                                                "Lan remembers she used her phone on the bus."),
                                createReadingExercise(
                                                "What did Lan do after she felt panic?",
                                                "She took a deep breath and thought clearly",
                                                Arrays.asList("She ran away",
                                                                "She took a deep breath and thought clearly",
                                                                "She bought a new phone",
                                                                "She called the police immediately"),
                                                "The passage says she took a deep breath and tried to think clearly."),
                                createReadingExercise(
                                                "What lesson did Lan learn?",
                                                "Staying calm helps you solve problems",
                                                Arrays.asList("Buses are always late", "Music is dangerous",
                                                                "Staying calm helps you solve problems",
                                                                "Phones should be turned off"),
                                                "At the end, it says staying calm helps you find solutions faster.")));
                lesson5.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_05"), lesson5);
                count++;

                // Lesson 6: News - Sleep and Learning
                Map<String, Object> lesson6 = new HashMap<>();
                lesson6.put("id", "reading_06");
                lesson6.put("title", "Why Sleep Matters for Learning");
                lesson6.put("description", "Learn how sleep supports memory and focus.");
                lesson6.put("level", "B1");
                lesson6.put("category", "news");
                lesson6.put("imageUrl", "https://source.unsplash.com/featured/1200x800?sleep,night,bed");
                lesson6.put("passage",
                                "People often think learning happens only while studying, but your brain also learns while you sleep. During sleep, the brain organizes information from the day. It strengthens useful memories and removes some unnecessary details. This process can improve your ability to remember new words, grammar rules, and facts.\n\n"
                                                + "Sleep also affects focus. If you sleep too little, you may feel tired and distracted. You might read the same paragraph many times without understanding it. With enough sleep, your attention improves and you can learn faster.\n\n"
                                                + "To sleep better, keep a regular schedule. Try to go to bed and wake up at similar times each day. Reduce screen time before bed, and make your room darker and quieter. Even small changes can improve sleep quality.\n\n"
                                                + "If you are learning English, sleep is part of your study plan. A well-rested brain is more prepared to understand, remember, and use the language.");
                lesson6.put("wordCount", 460);
                lesson6.put("estimatedMinutes", 4);
                lesson6.put("keyVocabulary",
                                Arrays.asList("organizes", "strengthens", "focus", "distracted", "regular", "quality"));
                lesson6.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "What does the brain do during sleep?",
                                                "It organizes information and strengthens memories",
                                                Arrays.asList("It forgets everything",
                                                                "It organizes information and strengthens memories",
                                                                "It stops working completely",
                                                                "It only dreams about food"),
                                                "The passage says the brain organizes information and strengthens useful memories."),
                                createReadingExercise(
                                                "Why is sleep important for focus?",
                                                "It helps you avoid being tired and distracted",
                                                Arrays.asList("It makes screens brighter",
                                                                "It prevents learning new words",
                                                                "It helps you avoid being tired and distracted",
                                                                "It replaces studying"),
                                                "It explains that too little sleep makes you tired and distracted."),
                                createReadingExercise(
                                                "Which habit can improve sleep quality?",
                                                "Keeping a regular schedule",
                                                Arrays.asList("Going to bed at random times",
                                                                "Keeping a regular schedule",
                                                                "Drinking coffee at midnight",
                                                                "Watching videos in bed for hours"),
                                                "It recommends going to bed and waking up at similar times each day.")));
                lesson6.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_06"), lesson6);
                count++;

                // Lesson 7: News - City Bikes
                Map<String, Object> lesson7 = new HashMap<>();
                lesson7.put("id", "reading_07");
                lesson7.put("title", "City Bikes and Cleaner Air");
                lesson7.put("description", "Read about bike lanes and cleaner cities.");
                lesson7.put("level", "B1");
                lesson7.put("category", "news");
                lesson7.put("imageUrl", "https://source.unsplash.com/featured/1200x800?bicycle,city");
                lesson7.put("passage",
                                "In many cities, traffic is a daily problem. Cars move slowly, streets are noisy, and the air becomes dirty. To reduce these issues, some cities invest in bike lanes and public bicycle systems.\n\n"
                                                + "When bike lanes are safe and connected, more people choose bicycles for short trips. This can reduce traffic, save time, and improve public health. Cycling is also cheaper than driving.\n\n"
                                                + "However, building a bike-friendly city takes planning. Bike lanes need clear signs, good lighting, and enough space. Drivers and cyclists must also learn to share the road respectfully.\n\n"
                                                + "Experts say cities that support cycling often become more comfortable for everyone, including people who still use cars. Cleaner air and quieter streets are benefits shared by the whole community.");
                lesson7.put("wordCount", 480);
                lesson7.put("estimatedMinutes", 4);
                lesson7.put("keyVocabulary", Arrays.asList("traffic", "invest", "connected", "public health",
                                "planning", "community"));
                lesson7.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "Why do cities build bike lanes?",
                                                "To reduce traffic and pollution",
                                                Arrays.asList("To increase traffic", "To reduce traffic and pollution",
                                                                "To make streets noisier",
                                                                "To stop people from walking"),
                                                "The first paragraph says cities invest in bike lanes to reduce traffic and dirty air."),
                                createReadingExercise(
                                                "What can make more people choose bicycles?",
                                                "Safe and connected bike lanes",
                                                Arrays.asList("Unsafe roads", "Safe and connected bike lanes",
                                                                "More expensive bikes", "Fewer signs"),
                                                "It states that safe and connected lanes encourage more people to cycle."),
                                createReadingExercise(
                                                "What must drivers and cyclists learn?",
                                                "To share the road respectfully",
                                                Arrays.asList("To avoid each other forever",
                                                                "To share the road respectfully", "To drive faster",
                                                                "To remove bike lanes"),
                                                "The passage says they must learn to share the road respectfully.")));
                lesson7.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_07"), lesson7);
                count++;

                // Lesson 8: Story - A Kind Message
                Map<String, Object> lesson8 = new HashMap<>();
                lesson8.put("id", "reading_08");
                lesson8.put("title", "A Kind Message");
                lesson8.put("description", "A short story about confidence and support.");
                lesson8.put("level", "A2");
                lesson8.put("category", "story");
                lesson8.put("imageUrl", "https://source.unsplash.com/featured/1200x800?friendship,message");
                lesson8.put("passage",
                                "Mai was nervous about her English presentation. She practiced at home, but her voice shook when she imagined the classroom. On the morning of the presentation, she felt her stomach tighten.\n\n"
                                                + "Before class, she opened her phone and saw a message from her friend: \"You can do it. Speak slowly. I believe in you.\" Mai read it twice. The words were simple, but they felt warm and real.\n\n"
                                                + "During the presentation, Mai still felt nervous, but she remembered the message. She paused, breathed, and continued. Her classmates listened, and the teacher smiled.\n\n"
                                                + "After class, Mai thanked her friend. She realized that support does not always need big actions. Sometimes a short, kind message is enough to change a day.");
                lesson8.put("wordCount", 340);
                lesson8.put("estimatedMinutes", 3);
                lesson8.put("keyVocabulary",
                                Arrays.asList("nervous", "presentation", "believe", "paused", "breathed", "support"));
                lesson8.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "Why was Mai nervous?",
                                                "She had an English presentation",
                                                Arrays.asList("She lost her phone", "She had an English presentation",
                                                                "She hated messages", "She was late for class"),
                                                "The first sentence says Mai was nervous about her English presentation."),
                                createReadingExercise(
                                                "What did Mai do during the presentation?",
                                                "She paused, breathed, and continued",
                                                Arrays.asList("She stopped immediately",
                                                                "She paused, breathed, and continued",
                                                                "She ran out of the room", "She forgot her name"),
                                                "The passage states she paused, breathed, and continued."),
                                createReadingExercise(
                                                "What did Mai learn at the end?",
                                                "A kind message can change a day",
                                                Arrays.asList("Support always needs big actions",
                                                                "A kind message can change a day",
                                                                "Messages are useless",
                                                                "Presentations should be canceled"),
                                                "At the end, she realizes a short, kind message can change a day.")));
                lesson8.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_08"), lesson8);
                count++;

                // Lesson 9: News - Remote Work
                Map<String, Object> lesson9 = new HashMap<>();
                lesson9.put("id", "reading_09");
                lesson9.put("title", "Remote Work: Benefits and Challenges");
                lesson9.put("description", "Read about the pros and cons of working remotely.");
                lesson9.put("level", "B2");
                lesson9.put("category", "news");
                lesson9.put("imageUrl", "https://source.unsplash.com/featured/1200x800?remote-work,laptop,home-office");
                lesson9.put("passage",
                                "Remote work has become common in many industries. For some workers, it offers important benefits. They save commuting time, have more flexible schedules, and can work in a quieter environment. Some companies also reduce costs by using smaller offices.\n\n"
                                                + "However, remote work brings challenges. Communication can become harder when people are not in the same room. Small problems may take longer to solve, and misunderstandings can happen more easily. New employees may also feel isolated because they do not meet coworkers in person.\n\n"
                                                + "To succeed, teams often set clear routines. They use shared calendars, short daily check-ins, and written summaries after meetings. These habits help everyone stay aligned. Remote workers also need boundaries. Without boundaries, they may work too long and feel burned out.\n\n"
                                                + "Experts suggest a balanced approach. Many companies choose hybrid work, where employees spend some days at home and some days in the office. This model tries to keep flexibility while supporting teamwork and social connection.");
                lesson9.put("wordCount", 540);
                lesson9.put("estimatedMinutes", 5);
                lesson9.put("keyVocabulary", Arrays.asList("commuting", "flexible", "communication", "isolated",
                                "boundaries", "hybrid"));
                lesson9.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "What is one benefit of remote work mentioned in the passage?",
                                                "Saving commuting time",
                                                Arrays.asList("Longer commuting time", "Saving commuting time",
                                                                "More misunderstandings", "No schedules"),
                                                "It says remote workers save commuting time."),
                                createReadingExercise(
                                                "What is a common challenge of remote work?",
                                                "Communication can become harder",
                                                Arrays.asList("Communication can become harder",
                                                                "Offices become larger", "People never need meetings",
                                                                "Employees always feel connected"),
                                                "The passage highlights communication is harder when people are not together."),
                                createReadingExercise(
                                                "Why do teams use written summaries after meetings?",
                                                "To stay aligned",
                                                Arrays.asList("To stay aligned", "To avoid teamwork",
                                                                "To make work slower", "To reduce clarity"),
                                                "Written summaries help everyone stay aligned.")));
                lesson9.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_09"), lesson9);
                count++;

                // Lesson 10: Story - The Mountain Path
                Map<String, Object> lesson10 = new HashMap<>();
                lesson10.put("id", "reading_10");
                lesson10.put("title", "The Mountain Path");
                lesson10.put("description", "A story about patience and steady effort.");
                lesson10.put("level", "B1");
                lesson10.put("category", "story");
                lesson10.put("imageUrl", "https://source.unsplash.com/featured/1200x800?mountain,hiking,trail");
                lesson10.put("passage",
                                "On Saturday morning, Tuan decided to hike a small mountain near his town. The weather was cool, and the sky was clear. At the start of the path, he felt excited and walked quickly.\n\n"
                                                + "After twenty minutes, the slope became steeper. Tuan's legs started to ache, and his breathing became heavy. He considered turning back. Then he noticed an older man walking slowly ahead. The man took small steps, paused when needed, and kept moving without hurry.\n\n"
                                                + "Tuan followed the same rhythm. Step by step, the path felt less frightening. He stopped thinking about the top and focused on the next few meters. After another half hour, the trees opened and the view appeared. The town looked quiet and far away.\n\n"
                                                + "Tuan realized the climb was not about speed. It was about patience and steady effort. On the way down, he smiled. The mountain had taught him a lesson he could use in study and in life.");
                lesson10.put("wordCount", 500);
                lesson10.put("estimatedMinutes", 4);
                lesson10.put("keyVocabulary",
                                Arrays.asList("hike", "slope", "steeper", "ache", "rhythm", "patience", "steady"));
                lesson10.put("exercises", Arrays.asList(
                                createReadingExercise(
                                                "Why did Tuan want to turn back?",
                                                "The slope became steeper and he felt tired",
                                                Arrays.asList("The sky was clear",
                                                                "The slope became steeper and he felt tired",
                                                                "He forgot his phone", "He met a friend"),
                                                "It says the slope became steeper and his legs started to ache."),
                                createReadingExercise(
                                                "What did the older man do while walking?",
                                                "He took small steps and paused when needed",
                                                Arrays.asList("He ran quickly",
                                                                "He took small steps and paused when needed",
                                                                "He sat down and quit", "He walked backward"),
                                                "The passage describes the man taking small steps and pausing when needed."),
                                createReadingExercise(
                                                "What lesson did Tuan learn?",
                                                "Patience and steady effort matter",
                                                Arrays.asList("Speed is everything",
                                                                "Patience and steady effort matter",
                                                                "Mountains are dangerous", "Studying is easy"),
                                                "At the end, Tuan realizes the climb is about patience and steady effort.")));
                lesson10.put("createdAt", new Date());
                batch.set(db.collection("reading_lessons").document("reading_10"), lesson10);
                count++;
        ...
        private Map<String, Object> createReadingExercise(String question, String correctAnswer, List<String> options) {
                return createReadingExercise(question, correctAnswer, options, null);
        }
        ...
        public void seedWritingLessons(SeedCallback callback) {
                ...
                lesson1.put("prompts", Arrays.asList(
                                createWritingPrompt("My Favorite Hobby",
                                                "Write a paragraph about your favorite hobby. Include why you like it and how often you do it."),
                                createWritingPrompt("My Daily Routine",
                ...
                lesson2.put("prompts", Arrays.asList(
                                createWritingPrompt("Job Application Email",
                                                "Write a formal email applying for a job as an English teacher."),
                                createWritingPrompt("Email to a Friend",
                                                "Write an informal email to a friend about your recent vacation.")));
                lesson2.put("createdAt", new Date());
                ...
                lesson3.put("prompts", Arrays.asList(
                                createWritingPrompt("Technology in Education",
                                                "Do you think technology has improved education? Write an essay expressing your opinion."),
                                createWritingPrompt("Working from Home",
                                                "Is working from home better than working in an office? Give your opinion with reasons and examples.")));
                lesson3.put("createdAt", new Date());

...
/**
 * SmartPauseDetectionManager - Phát hiện khi người dùng dừng đọc và tự động đề xuất giúp đỡ
...
public class SmartPauseDetectionManager {
     ...
     */
    private void onPauseDetected(Context context, String fullText, int scrollPosition, PauseDetectionCallback callback) {
